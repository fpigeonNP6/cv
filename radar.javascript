...
var radarChartOptions = {
				...
				function RadarChart(id, data, options) {
					...
					var dataset = []
					var circleAttrs = {
						cx: function(d) { return rScale(d.percent) * Math.cos(angleSlice*d.i - Math.PI/2); },
						cy: function(d) {return rScale(d.percent) * Math.sin(angleSlice*d.i - Math.PI/2); },
						r: radius
					};
				  ...
				  function handleMouseOut(d, i) {
					...
					blobWrapper
						...
						.attr("d", function(d,i) { if(i!=3){return radarLine(d); }})
						.style("fill", function(d,i) { return "#329AF0"; })
						.style("fill-opacity", function(d,i) {return 0.2;})
						...
						.on('mouseout', function(){
							...
							d3.selectAll(".radarArea")
								.transition().duration(200)
								.style("fill-opacity", function(d,i) {return 0.7;});
							div.transition()
								.duration(200)
								.style("opacity", 0);
						});
					...
					blobWrapper.append("path")
						...
						.style("stroke", function(d,i) { return "#329AF0"; })
						.style("fill", "none")
						.style("filter" , "url(#glow)");		
					...
					blobWrapper.selectAll(".radarCircle")
						...
						.attr("cx", function(d,i){ return rScale(d.percent) * Math.cos(angleSlice*i - Math.PI/2); })
						.attr("cy", function(d,i){ return rScale(d.percent) * Math.sin(angleSlice*i - Math.PI/2); })
						.style("fill", function(d,i,j) { return "#329AF0"; })
